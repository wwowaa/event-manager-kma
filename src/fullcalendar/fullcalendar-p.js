    ...
    <div className={`${s['fullcalendar']}`}>
      ...
      <section className={`${s['wf-section']}`}>
        <div className={`${s['w-layout-grid']} ${s['grid-2']}`}>
          ...
          >
            <div data-hover="false" data-delay="0" className={`${s['dropdown']} ${s['w-dropdown']}`}>
              <div className={`${s['dropdown-toggle']} ${s['w-dropdown-toggle']}`}>
      ...
      <section className={`${s['section-5']} ${s['wf-section']}`}>
        <div className={`${s['container-10']} ${s['w-container']}`}>
          <a href="./mainpage.html" className={`${s['button-2']} ${s['w-button']}`}>
            BACK
          </a>
        </div>
      </section>
